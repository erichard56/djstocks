	...
	$('form[name=account-settings]').submit(function(evt) {
		...
		$.post('settings.php', {
			...
			if(data == '1') {
				...
				alert('110 Algo salió mal. Por favor, inténtelo de nuevo');
				return false;
			}
		});
	});
	...
	$('form[name=change-password]').submit(function(evt) {
		...
		$.post('settings.php', {
			...
			if(data == '1') {
				...
				alert('111 Algo salió mal. Por favor, inténtelo de nuevo');
				return false;
			}
		});
	});
	...
	$('form[name=invento-settings]').submit(function(evt) {
		...
		$.post('settings.php', {
			...
			if(data == '1') {
				...
				alert('112 Algo salió mal. Por favor, inténtelo de nuevo');
				return false;
			}
		});
	});
